...
public:
  LSM9DS1(const char *acc_gyro_device_path, const char *mag_device_path,
          bool mag_enabled = true)
      : ImuSensor(acc_gyro_device_path, LSM9DS1_MEASURE_INTERVAL_US,
                  mag_enabled),
        _mag_enabled(mag_enabled), _last_temp_c(0.0f), _temp_initialized(false),
        _mag_device_path(mag_device_path), _mag(nullptr) {
